...
def listen_on_port(ip, port):
    ...
    while True:
        try:
            ...
            currentcarinformation = currentcarinformation.split(' ')
            currentcarinformation = ("Make: " + currentcarinformation[0] +  '\n' + " Model: " + currentcarinformation[1] +  '\n' +" Model Year: " +
                                 currentcarinformation[2] +  '\n' +" Keywords: " + currentcarinformation[3] +  '\n' +" Country of Origin: " +
                                 currentcarinformation[4] +  '\n' +" Msrp: " + currentcarinformation[5] +  '\n' +" Asking Price: " +
                                 currentcarinformation[6] +  '\n' +" Engine Displacement Size: " + currentcarinformation[7] + '\n' +
                                 " Num Doors: " + currentcarinformation[8] +  '\n' +" Drivetrain Type: " + currentcarinformation[9] +
                                     '\n' +" Engine Config Type: " + currentcarinformation[10] +  '\n' +" Number Cylinders: " +
                                 currentcarinformation[11] +  '\n' +" Horse Power: " + currentcarinformation[12] + '\n' + " Num Seat Rows: " +
                                 currentcarinformation[13] +  '\n' +" Num Seats: " + currentcarinformation[14] + '\n' +" Is Turbocharged: " +
                                 currentcarinformation[15])
            ...
            if not zipcodeflag:
                ...
                currentnearestowner = "Name: " + nearestowner[0] + ", " + nearestowner[1] + ", " +nearestowner[2] + ", " + nearestowner[3] + ", " + nearestowner[4]
